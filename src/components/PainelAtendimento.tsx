...
interface PainelAtendimentoProps {
  ...
  abaInicial?: 'interesse' | 'agendamentos';
}

type AbaAtiva = 'interesse' | 'agendamentos';
      ...
      <div className="fixed right-0 top-0 h-full w-[400px] max-w-full bg-[#1e293b] border-l border-[#334155] z-50 flex flex-col">
            ...
            >
              ...
              {agendamentos.length > 0 && (
                <span className={`text-xs px-1.5 py-0.5 rounded-full ${
                  abaAtiva === 'agendamentos' ? 'bg-white/20' : 'bg-purple-500/20 text-purple-400'
                }`}>
                  {agendamentos.length}
                </span>
              )}
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          {abaAtiva === 'interesse' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h4 className="font-medium text-sm text-[#64748b]">Procedimentos de Interesse</h4>
                <button
              ...
              {loadingLeadProcedimentos ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-[#64748b]">Nenhum procedimento vinculado</p>
                  <p className="text-xs text-[#475569] mt-1">Clique no + para adicionar</p>
                </div>
              ) : (
                <div className="space-y-2">
                  ...
                  {/* Total */}
                  <div className="flex items-center justify-between p-3 bg-[#10b981]/10 rounded-lg border border-[#10b981]/30 mt-4">
          ...
          {abaAtiva === 'agendamentos' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h4 className="font-medium text-sm text-[#64748b]">Agendamentos</h4>
                <button
              ...
              {loadingAgendamentos ? (
                ...
                <div className="text-center py-8">
                  <Calendar size={40} className="mx-auto text-[#334155] mb-3" />
                  <p className="text-sm text-[#64748b]">Nenhum agendamento</p>
                  <p className="text-xs text-[#475569] mt-1">Clique no + para agendar</p>
                </div>
              ) : (
                <div className="space-y-2">
                  {agendamentos.map((ag) => {
