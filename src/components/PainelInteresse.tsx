...
export default function PainelInteresse({
  ...
  return (
    <>
      ...
      {/* Painel */}
      <div className="fixed right-0 top-0 h-full w-[380px] max-w-full bg-[#1e293b] border-l border-[#334155] z-50 flex flex-col">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 bg-[#10b981] hover:bg-[#059669] rounded-lg text-sm transition-colors"
            >
              <Plus size={16} />
              Adicionar
            </button>
          ...
          {loadingLeadProcedimentos ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-[#64748b]">Nenhum procedimento vinculado</p>
            ...
            <div className="space-y-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      {lp.procedimento?.retorno_dias && (
                        <span className="text-xs text-[#64748b] bg-[#334155] px-2 py-0.5 rounded">
              ...
              {/* Total */}
              {leadProcedimentos.length > 0 && (
                <div className="flex items-center justify-between p-4 bg-[#10b981]/10 rounded-lg border border-[#10b981]/30 mt-4">
                  <span className="font-medium text-[#10b981]">Total Estimado</span>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#1e293b] border border-[#334155] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#10b981]"
                  >
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 bg-[#10b981] hover:bg-[#059669] disabled:bg-[#334155] disabled:text-[#64748b] rounded-lg text-sm transition-colors flex items-center justify-center gap-2"
                  >
